...
Source0  : https://download.gnome.org/sources/gtk-vnc/1.2/gtk-vnc-1.2.0.tar.xz
...
%prep
%setup -q -n gtk-vnc-1.2.0
cd %{_builddir}/gtk-vnc-1.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619144883
...
cp %{_builddir}/gtk-vnc-1.2.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/gtk-vnc/81221edbef5521188d99b7c699d326e85b8c3e87
cp %{_builddir}/gtk-vnc-1.2.0/subprojects/keycodemapdb/LICENSE.BSD %{buildroot}/usr/share/package-licenses/gtk-vnc/ea5b412c09f3b29ba1d81a61b878c5c16ffe69d8
cp %{_builddir}/gtk-vnc-1.2.0/subprojects/keycodemapdb/LICENSE.GPL2 %{buildroot}/usr/share/package-licenses/gtk-vnc/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
